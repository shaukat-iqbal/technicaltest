...
import TemporaryLocationsList from "./TemporaryLocationsList";
...
class LocationRenderer extends React.Component {
  ...
  childsOf = id => {
    return this.state.allCategories.filter(c => c.parentLocation === id);
  };
  ...
  getRootCategories = () => {
    return this.state.allCategories.filter(c => !c.parentLocation);
  };
